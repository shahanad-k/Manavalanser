...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'help ?(.*)', fromMe: true, dontAddCommandhelp: true}, (async (message, match) => {

        var CMD_HELP = '';
        if (match[1] === '') {
            Asena.commands.map(
                async (command) =>  {
                    if (command.dontAddCommandhelp || command.pattern === undefined) return;
                    try {
     ...
     Asena.addCommand({pattern: 'help ?(.*)', fromMe: false, dontAddCommandhelp: true}, (async (message, match) => {
...
async function checkImAdmin(message, user = message.client.user.jid) {
    ...
    return sonuc.includes(true);
     ...
     Asena.addCommand({pattern: 'help ?(.*)', fromMe: false, dontAddCommandhelp: true}, (async (message, match) => {
         ...
         if (!us) return await message.client.sendMessage(message.jid,Lang.MSADMIN ,MessageType.text ,{quoted: message.data });
